          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            <div>
              <ScrollReveal>
                ...
                <h2 className="font-display font-black uppercase leading-[0.88] text-[clamp(42px,5vw,72px)] text-cream mb-8">
              ...
              <div className="space-y-3 mb-10">
                {info.map((item, i) => (
                  <ScrollReveal key={item.label} delay={i * 80}>
                    <div className="card-premium p-6 flex items-start gap-5">
                      <div className="w-10 h-10 border border-gold/20 flex items-center justify-center text-gold shrink-0">
                        {item.icon}
                      </div>
                      <div>
                        <p className="font-display text-[10px] font-semibold uppercase tracking-[0.3em] text-ash/60 mb-1">{item.label}</p>
                        <p className="text-cream font-semibold text-base">{item.primary}</p>
                        <p className="text-ash text-sm font-light mt-0.5">{item.secondary}</p>
                      </div>
                    </div>
                  </ScrollReveal>
                ))}
              ...
              <ScrollReveal delay={200}>
                <div className="card-premium p-6 mb-10">
                  <p className="font-display text-[10px] font-semibold uppercase tracking-[0.3em] text-ash/60 mb-5">Nearby Landmarks</p>
                  <ul className="grid grid-cols-2 gap-3">
                    {nearbyLandmarks.map((lm) => (
                      <li key={lm} className="flex items-center gap-2.5 text-sm">
                        ...
                        <span className="text-mist">{lm}</span>
                      </li>
                    ))}
                  </ul>
                </div>
              ...
              <ScrollReveal delay={300}>
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="btn-outline flex-1 justify-center gap-2.5"
                  >
            ...
            <div className="space-y-4">
              ...
              <ScrollReveal direction="right">
                <div className="relative h-72 lg:h-80 bg-ink overflow-hidden border border-white/[0.05]">
                  {/* Replace with <iframe src="...google maps embed..." /> */}
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-8">
                    <div className="w-14 h-14 border border-gold/20 flex items-center justify-center text-gold mb-4">
                      <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m6-6v8.25m.503 3.498l4.875-2.437c.381-.19.622-.58.622-1.006V4.82c0-.836-.88-1.38-1.628-1.006l-3.869 1.934c-.317.159-.69.159-1.006 0L9.503 3.252a1.125 1.125 0 00-1.006 0L3.622 5.689C3.24 5.88 3 6.27 3 6.695V19.18c0 .836.88 1.38 1.628 1.006l3.869-1.934c.317-.159.69-.159 1.006 0l4.994 2.497c.317.158.69.158 1.006 0z"/>
                      </svg>
                    </div>
                    <p className="font-display font-bold uppercase tracking-[0.1em] text-cream text-base">Google Maps Embed</p>
                    <p className="text-ash/50 text-xs mt-2 leading-relaxed">
              ...
              <ScrollReveal direction="right" delay={250}>
                <div className="card-premium p-6">
                  <p className="font-display text-[10px] font-semibold uppercase tracking-[0.3em] text-ash/60 mb-5">Operating Hours</p>
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-mist text-sm font-light">Monday – Saturday</span>
                      <span className="text-gold font-display font-bold text-sm tracking-wide">6:00 AM – 12:00 AM</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-mist text-sm font-light">Sunday & Public Holidays</span>
                    ...
                    <p className="text-ash/40 text-xs font-light">* Hours open until midnight every day of the year.</p>
                  </div>
                </div>
              </ScrollReveal>
            </div>
