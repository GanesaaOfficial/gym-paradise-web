  ...
  return (
    ...
    <section ref={containerRef} className="relative w-full h-[400vh] max-lg:h-auto bg-void" id="features">
      <div className="sticky top-0 w-full h-[100svh] overflow-hidden bg-void max-lg:relative max-lg:h-auto max-lg:overflow-visible">
        ...
        <div className="absolute inset-4 lg:inset-8 border border-white/10 z-40 pointer-events-none flex flex-col justify-between p-4 lg:p-6">
          {/* Corner Brackets */}
          ...
          {features.map((feature, idx) => {
            return (
              ...
              >
                ...
                <div 
                  className="absolute top-1/2 right-0 lg:-right-32 -translate-y-1/2 font-display font-black text-[25rem] lg:text-[60rem] leading-none pointer-events-none z-0 opacity-15"
                ...
                <div className="relative z-20 w-full max-w-3xl lg:max-w-4xl h-full flex flex-col justify-center ml-0 lg:ml-12 transform-gpu">
                  ...
                  <div className="border-l-2 border-gold/50 pl-8 lg:pl-12 py-4 w-full">
                    ...
                    <h2 className="font-display font-black uppercase tracking-tighter text-cream mb-6 leading-[0.9] text-5xl md:text-6xl lg:text-[6.5rem]">
                      {feature.title}
                    </h2>

                    <p className="text-mist text-base lg:text-xl leading-relaxed font-medium mb-10 max-w-2xl">
                      {feature.desc}
                    </p>
                    ...
                    <div className="flex gap-12 lg:gap-16 pt-6">
                      <div>
                        <p className="font-display font-black text-4xl lg:text-5xl text-cream mb-1">{feature.stat1}</p>
                        <p className="text-gold text-[10px] lg:text-xs uppercase tracking-[0.2em] font-bold">{feature.stat1Label}</p>
                      </div>
                      <div>
                        <p className="font-display font-black text-4xl lg:text-5xl text-cream mb-1">{feature.stat2}</p>
        ...
        <div className="hidden lg:flex absolute bottom-8 lg:bottom-12 left-1/2 -translate-x-1/2 z-30 pointer-events-none flex-col items-center gap-4">
          <div className="text-gold text-xs font-display tracking-[0.3em] uppercase font-bold bg-void/80 px-4 py-1 rounded-full border border-white/10">
            Scroll to Explore
          </div>
          <div className="h-1.5 rounded-full bg-white/10 overflow-hidden w-64 lg:w-96 relative border border-white/5 shadow-2xl">
            <div 
